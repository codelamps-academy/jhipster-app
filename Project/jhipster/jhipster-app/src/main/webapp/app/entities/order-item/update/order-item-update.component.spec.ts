...
describe('OrderItem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 15356 };
      orderItem.product = product;

      const productCollection: IProduct[] = [{ id: 26565 }];
    ...
    it('Should call ProductOrder query and add missing value', () => {
      const orderItem: IOrderItem = { id: 456 };
      const order: IProductOrder = { id: 5959 };
      orderItem.order = order;

      const productOrderCollection: IProductOrder[] = [{ id: 13869 }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: 456 };
      const product: IProduct = { id: 32344 };
      orderItem.product = product;
      const order: IProductOrder = { id: 3197 };
      orderItem.order = order;
