...
import com.codelamps.domain.enumeration.Gender;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "RtE>_@Y`}A-u._l";
    private static final String UPDATED_EMAIL = "\\P5x@:b\\.Oown";
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.gender(UPDATED_GENDER).phone(UPDATED_PHONE);
